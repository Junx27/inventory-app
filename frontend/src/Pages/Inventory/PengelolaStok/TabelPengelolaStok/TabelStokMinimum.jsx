...
import { dataStokMinimum } from "../../../../Data/data";
import FormaterRupiah from "../../../../Components/FormatRupiah";
function TabelStokMinimum() {
  const data = dataStokMinimum;
              ...
              <tr className="border">
                <th colSpan={"2"} className="border px-3 py-5">
                  <div className="grid grid-cols-5 gap-5 mt-5 mx-12">
                    ...
                    <p className="text-center">Stok Minimum</p>
                    <p className="text-center">Stok Sekarang</p>
                  ...
                  <td className="border px-3 py-4">
                    <div className="grid grid-cols-5">
                        ...
                        <h1 className="font-bold capitalize">
                          ...
                          <span
                            className={`relative ml-3 rounded-full text-center p-1 text-[10px] font-normal pl-5 pr-3 ${
                              item.stok_sekarang === item.stok_minimum
                      ...
                      <div className="w-32 text-xs text-end font-bold">
                        <p>{item.stok_minimum}</p>
                      </div>
                      <div
                        className={`relative ml-3 rounded-full text-center p-1 text-xs font-normal pl-5 pr-3 ${
                          item.stok_sekarang === item.stok_minimum
                            ? "text-blue-600"
                            : item.stok_sekarang < item.stok_minimum
                            ? "text-red-600"
                      ...
                      <div className="text-xs text-green-500">
                        <FormaterRupiah
                          number={item.stok_sekarang * item.harga}
                          label={"+"}
                        />
                      </div>
                    </div>
...
export default TabelStokMinimum;
